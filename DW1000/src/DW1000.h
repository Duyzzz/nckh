...
public:
	...
	*/
	...
	// 850 kbps modes (middle ground between 110k and 6.8M)
	static constexpr byte MODE_MEDDATA_MID_LOWPOWER[]     = {TRX_RATE_850KBPS,  TX_PULSE_FREQ_16MHZ, TX_PREAMBLE_LEN_1024};
	static constexpr byte MODE_MEDDATA_MID_ACCURACY[]     = {TRX_RATE_850KBPS,  TX_PULSE_FREQ_64MHZ, TX_PREAMBLE_LEN_1024};
	// Preamble 64 modes (shortest acquisition time, minimum range sensitivity)
	static constexpr byte MODE_SHORTDATA_FASTEST_LOWPOWER[]  = {TRX_RATE_6800KBPS, TX_PULSE_FREQ_16MHZ, TX_PREAMBLE_LEN_64};
	static constexpr byte MODE_SHORTDATA_FASTEST_ACCURACY[]  = {TRX_RATE_6800KBPS, TX_PULSE_FREQ_64MHZ, TX_PREAMBLE_LEN_64};
